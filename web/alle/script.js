...
const total_coordinate_array = [...etappe_1_coordinates, ...etappe_2_coordinates, ...etappe_3_coordinates, ...etappe_4_coordinates];
const total_elevation_array = [...etappe_1_altitude_array, ...etappe_2_altitude_array, ...etappe_3_altitude_array, ...etappe_4_altitude_array];


// Distance array needs to add previous distance from earlier etappe, which is what we are doing here
var all_distance_arrays = [etappe_1_distance_array, etappe_2_distance_array, etappe_3_distance_array, etappe_4_distance_array];
...
for (var i=0; i<etappe_3_distance_array.length; i++) {
  total_distance_array.push(etappe_1_distance_array[etappe_1_distance_array.length-1]+etappe_2_distance_array[etappe_2_distance_array.length-1]+etappe_3_distance_array[i]);
}

for (var i=0; i<etappe_4_distance_array.length; i++) {
  total_distance_array.push(etappe_1_distance_array[etappe_1_distance_array.length-1]+etappe_2_distance_array[etappe_2_distance_array.length-1]+etappe_3_distance_array[etappe_3_distance_array.length-1]+etappe_4_distance_array[i])
}
